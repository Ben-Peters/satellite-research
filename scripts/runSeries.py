...
a = subprocess.Popen("python3 ./runTrialTrimmed.py --batch 133 --cc cubic --time 100 --tcpSettings 14")
a.wait()
b = subprocess.Popen("python3 ./runTrialTrimmed.py --batch 134 --cc cubic --time 100 --tcpSettings 15")
b.wait()
c = subprocess.Popen("python3 ./runTrialTrimmed.py --batch 135 --cc cubic --time 100 --tcpSettings 16")
c.wait()
d = subprocess.Popen("python3 ./runTrialTrimmed.py --batch 136 --cc cubic --time 100 --tcpSettings 17")
d.wait()
e = subprocess.Popen("python3 ./runTrialTrimmed.py --batch 137 --cc cubic --time 100 --tcpSettings 18")
e.wait()
f = subprocess.Popen("python3 ./runTrialTrimmed.py --batch 138 --cc cubic --time 100 --tcpSettings 19")
f.wait()
g = subprocess.Popen("python3 ./runTrialTrimmed.py --batch 139 --cc cubic --time 100 --tcpSettings 20")
g.wait()
h = subprocess.Popen("python3 ./runTrialTrimmed.py --batch 140 --cc cubic --time 100 --tcpSettings 21")
h.wait()
